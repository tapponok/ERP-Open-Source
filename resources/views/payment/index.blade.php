...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h3 class="subheader-title">
            <i class='subheader-icon fal fa-table'></i>Payment
        </h3>
                ...
                <div class="modal-body">
                    <form action="{{route('payment.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter payment"
                                required>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" id="updateForm" method="POST">
                    ...
                    {{ method_field('PUT') }}
                    <div class="modal-body">
                        <input type="text" name="name" class="form-control" value="" placeholder="Enter payment"
                            required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
    $('#updateModal').on('show.bs.modal', function (e) {
        var categName = $(e.relatedTarget).data('name');
